...
function NewJob(props) {
  const [position, setPosition] = useState({ lat: 30.288339342671262, lng: -97.74467650290607 });
  ...
  return (
    <APIProvider apiKey={process.env.REACT_APP_GOOGLE_MAPS_API_KEY}>
      <div style={{ height: "100vh", width: "100%" }}>
        <Map defaultZoom={15} defaultCenter={position} mapId={process.env.NEXT_PUBLIC_MAP_ID}>
